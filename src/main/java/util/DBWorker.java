...
public class DBWorker {
	...
	public Integer changeDBData(String query)
	{
		...
		try
		{
			...
			connect = DriverManager.getConnection("jdbc:mysql://localhost/phonebook?user=root&password=12345&useUnicode=true&characterEncoding=UTF-8"
					+ "&characterSetResults=utf8&connectionCollation=utf8_general_ci&useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Europe/Moscow");
			statement = connect.createStatement();
